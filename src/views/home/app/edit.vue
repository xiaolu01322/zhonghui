           ...
           <div class="form-box">
              <el-form  :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-form-inline" :label-position="labelPosition" label-width="110px" >
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="选择城市" prop="city">
                            <el-select v-model="ruleForm.city" value-key="code"  filterable multiple placeholder="--请选择城市--" @change="selectGet">
                                <el-option
                                v-for="item in citys"
                                :key="item.code"
                                :label="item.name"
                ...
                <el-form-item label="产品期限" prop="period">
                    <el-select v-model="ruleForm.period" multiple value-key="id" placeholder="请选择产品期限">
                        <el-option
