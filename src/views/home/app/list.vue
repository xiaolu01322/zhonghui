        ...
        <div class="container home-container">
           <div class="handle-box">
            ...
            <el-table :data="tableData" border class="table table-container-home" >
                <el-table-column prop="name" label="产品名称" width="100" align="center"> </el-table-column>
                ...
                <el-table-column prop="lendingChannel" label="放款通道" width="100" align="center"> </el-table-column>
                <el-table-column prop="repaymentMethod" label="还款方式" width="100" align="center"> </el-table-column>
                <el-table-column prop="repaymentDate" label="还款日" width="200" align="center"> </el-table-column>
                <el-table-column prop="borrowingCycle" label="借款周期" width="300" align="center"> </el-table-column>
                <el-table-column prop="adiRate" label="罚息年利率" width="100" align="center"> </el-table-column>
                <el-table-column prop="robFees" label="违约金比例" width="100" align="center"> </el-table-column>
        ...
        methods: {
            ...
            open() {
             ...
             getData() {
                ...
                this.__postData('appList', params, (res) => {                
